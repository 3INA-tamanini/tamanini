...
public class Automobile1_1 extends MezzoDiTrasporto5 {
    ...
    public void rimuoviUltimoPasseggero() throws Exception {
        ...
        try {
            ...
            passeggeri.remove(passeggeri.size());
    ...
    public void ordinaPasseggeri() throws Exception {
        ...
        if (passeggeri != null) {
            ...
            passeggeri.sort(Comparator.comparing(Persona8A::getNome));
    ...
    public Float calcolaBollo(Automobile1_1 a) throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            Automobile1_1 a = new Automobile1_1(100, 1000, "bianco", "FIAT", "Ciao", "12/12/2024", "AM644EE", 4, 3);
